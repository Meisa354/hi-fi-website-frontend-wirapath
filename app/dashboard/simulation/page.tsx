...
export default function CareerSimulationPage() {
  ...
  const getJobPositionId = (id: string) => {
  ...
  const getJobRole = (id: string) => {
    const map: Record<string, string> = {
      gojek: "Software Engineer",
      tokopedia: "Frontend Developer",
      bca: "IT Analyst",
      telkom: "Backend Developer",
      shopee: "Full Stack Developer",
      bukalapak: "Data Engineer",
      traveloka: "Mobile Developer",
    };
    return map[id] || "Software Engineer";
  };
          ...
          <div className="flex flex-col">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-8">
              ...
              <div className="lg:col-span-8 h-[480px] order-1 lg:order-2">
                <ChatSimulation 
                  companyName={getCompanyName(activeCompanyId)} 
                  jobPositionId={getJobPositionId(activeCompanyId)}
                  jobRole={getJobRole(activeCompanyId)}
                  type="recruiter"
                />
              </div>
            </div>
